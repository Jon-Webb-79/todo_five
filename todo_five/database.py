...
class SQLiteManager(QSqlDatabase):
    ...
    :param db_name: The name and path length to the SQLite database
    ...
    The SQLiteManager code examples assume the existence of a SQLite database named
    ...
    def __init__(
        ...
        msg = "Hostname, Username, and Password are not required in SQLite\n"
    ...
    def open_db(self) -> Tuple[bool, str]:
        ...
        return True, f"{self.db_name} database successfully opened"
    ...
    def close_db(self) -> Tuple[bool, str]:
        ...
        self.con.close()
        return True, f"{self.db_name} database successfully closed"
    ...
    def db_query(self, query: str, params: Tuple = None) -> Tuple[bool, QSqlQuery, str]:
        ...
        .. code-block::
            ...
            if success:
                ...
                print(f"ID: {ids}, Product: {products}, Number: {numbers}")
            else:
    ...
    def db_schema(self) -> Tuple[bool, dict[str, Dict[str, str]], str]:
        ...
        while table_query.next():
            ...
            column_query.exec_(f"PRAGMA table_info({table_name})")
            table_schema = {}
    ...
    def create_table(
        ...
        if len(column_names) != len(data_types):
            return False, "Column names and data types lists must be of the same length"
    ...
    def remove_db(self) -> None:
        ...
        This method removes the database object, so it does not get mangled with
        other objects.
        """
        if self.isOpen():
            self.close_db()
